 ...
 *
**/
#ifndef INCG_CPPBASE_COMPILER_HPP
#define INCG_CPPBASE_COMPILER_HPP
...
#define CPP_COMPILER_VERSION                                                                       \
    CPP_VERSION_CREATE(CPP_COMPILER_MAJOR, CPP_COMPILER_MINOR, CPP_COMPILER_PATCH)
 ...
 * \param patch Patch version to compare against CPP_COMPILER_PATCH
 * \note This doesn't check the compiler only the version
 * \sa CPP_COMPILER_VERSION_IS_ATLEAST, CPP_COMPILER_IS_ATLEAST, CPP_COMPILER_IS_BELOW,
       CPP_COMPILER_VERSION, CPP_COMPILER_MAJOR, CPP_COMPILER_MINOR, CPP_COMPILER_PATCH
**/
...
#endif // INCG_CPPBASE_COMPILER_HPP

#ifndef INCG_CPPBASE_WARNING_HPP
#define INCG_CPPBASE_WARNING_HPP
...
#    define CPP_COMPILER_WARNING(msg)                                                              \
        __pragma(message(__FILE__ "(" CPP_STRINGIFY(__LINE__) ") : warning: " #msg))
#else
...
#    define CPP_CLANG_SUPPRESS_WARNING(warning)                                                    \
        DETAIL_CPP_PRAGMA_TO_STR(clang diagnostic ignored warning)
...
#    define CPP_COMPILER_WARNING(msg)                                                              \
        _Pragma(CPP_STRINGIFY(                                                                     \
                GCC warning(__FILE__ "(" CPP_STRINGIFY(__LINE__) ") : warning: " msg)))
#else
...
#    endif
#    define CPP_GCC_SUPPRESS_WARNING(warning)                                                      \
        DETAIL_CPP_PRAGMA_TO_STR(GCC diagnostic ignored warning)
#    define CPP_GCC_SUPPRESS_WARNING_WITH_PUSH(warning)                                            \
        CPP_GCC_SUPPRESS_WARNING_PUSH CPP_GCC_SUPPRESS_WARNING(warning)
...
#endif // INCG_CPPBASE_WARNING_HPP
